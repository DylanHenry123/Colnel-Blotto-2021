...
class Game:
    ...
    def player_two_computer_choice(self):
        item = random.choices([[3, 3, 0], [3, 0, 3], [0, 3, 3], [4, 1, 1], [1, 4, 1], [1, 1, 4], [2, 2, 2],
                               [3, 2, 1], [3, 1, 2], [2, 3, 1], [2, 1, 3], [1, 3, 2], [1, 2, 3], [4, 2, 0],
                               [4, 0, 2], [2, 4, 0], [2, 0, 4], [0, 2, 4], [0, 4, 2], [5, 1, 0], [5, 0, 1],
                               [1, 5, 0], [1, 0, 5], [0, 5, 1], [0, 1, 5]], [9, 9, 9, 9, 9, 9, 12, 11, 11, 11, 11, 11,
                                                                             11, 8, 8, 8, 8, 8, 8, 5, 5, 5, 5, 5, 5])

        for i in range(len(item[0])):
            self.choices_two.append(item[0][i])
